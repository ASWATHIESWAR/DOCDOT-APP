      ...
      <div class="wrap-login100">
        <form class="login100-form validate-form">
          ...
          <span class="login100-form-title p-b-34 p-t-27">
            ...
            <h2 style="color:white; font-family:Calibri; font-size:120%;">AMITRIPTYLINE</h2>
          </span>
          <center>
          <p style="text-align: justify-all;">Amitriptyline is a tricyclic antidepressant. Amitriptyline affects chemicals in the brain that may be unbalanced in people with depression.

Amitriptyline is used to treat symptoms of depression.

Amitriptyline may also be used for purposes not listed in this medication guide</p>
<br>
<br>
 <h3>
