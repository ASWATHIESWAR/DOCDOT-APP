      ...
      <div class="wrap-login100">
        <form class="login100-form validate-form">
          ...
          <span class="login100-form-title p-b-34 p-t-27">
            ...
            <h2 style="color:white; font-family:Calibri; font-size:120%;">MOTRIN</h2>
          </span>
          <center>
          <p>Motrin (ibuprofen) is a nonsteroidal anti-inflammatory drug (NSAID). Ibuprofen works by reducing hormones that cause inflammation and pain in the body.

Motrin is used to reduce fever and treat pain or inflammation caused by many conditions such as headache, toothache, back pain, arthritis, menstrual cramps, or minor injury.</p>
<br>
<br>
 <h3>
