      ...
      <div class="wrap-login100">
        <form class="login100-form validate-form">
          ...
          <span class="login100-form-title p-b-34 p-t-27">
            ...
            <h2 style="color:white; font-family:Calibri; font-size:120%;">ACETAMINOPHEN</h2>
          </span>
          <center>
          <p>Acetaminophen is a pain reliever and a fever reducer.

Acetaminophen is used to treat mild to moderate and pain, to
 treat moderate to severe pain in conjunction with opiates, or to 
reduce fever. Common conditions that acetaminophen treats
 include headache, muscle aches, arthritis, backache, toothaches,
 colds, and fevers.

Acetaminophen may also be used for purposes not listed in this
 medication guide. It is typically used orally, but can be given
 intravenously.
