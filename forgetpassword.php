...
<body>
      ...
      <div class="wrap-login100">
        <form class="login100-form validate-form">
          ...
          <span class="login100-form-title p-b-34 p-t-27">
            ...
            <h2 style="color:white; font-family:Algerian; font-size:120%;">FORGET PASSWORD</h2>
              
            </span>
          <p style="color:black;font-family:Comic Sans MS;font-size: 20px">Please enter your E-mail address</p>
  ...
  <div class="container-login100-form-btn">
            <button class="login100-form-btn" style="width: 150px; height:48px; margin:15px;" >
              I FORGOT
            </button>
            </div>
